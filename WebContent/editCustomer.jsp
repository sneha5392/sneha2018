...
<!-- Below div is for show registration success message which is set in Adminservlet -->
			<div>
				<a href = "AllUserServlet?role=Customer">Back</a>
			</div>
...
<div class="main">
	...
	<%
		...
		while(rs.next()){
	%>
	<form name = "form" action="CustomerUpdateServlet?role=Customer" method="post" onsubmit="return validateFormOnSubmit(this);">
	<table align = "center" width = 50% cellspacing="30" class = "table_admin">
	<span id="errBox1" style="color:red"></span>
	<tr>
		<td width = 50%>User Id <span style = "color:red;">*</span> : </td>
