		...
		<div>
			...
			<table align=center cellspacing="2px" border="2">
				...
				<tr>
					...
					<td><a href="EditCustomerServlet?user_id=<%=rs.getString("user_id") %>&role=Customer">Edit</a> / <a href="CustomerDeleteServlet?user_id=<%=rs.getString("user_id")%>&role=Customer">Delete</a>
					</td>
				</tr>
				<%
					}
