...
<!--  header -->
	<div class="container">
		<div class="main"><br>
			...
			<div>
				<h1 align="center">All Vendors</h1>
				<%
				...
				<form action="VendorServlet" method="post">
					...
					<table align=center cellspacing="2px" border="2">
						...
						<tr>
							...
							<td><a href="EditCustomerServlet?user_id=<%=rs.getString("user_id") %>&role=Vendor">Edit</a> / <a href="CustomerDeleteServlet?user_id=<%=rs.getString("user_id")%>&role=Vendor">Delete</a>
							</td>
						</tr>
						<%
							}
