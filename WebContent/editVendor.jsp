...
<!-- Below div is for show registration success message which is set in Adminservlet -->
			<div>
				<a href = "AllUserServlet?role=Vendor">Back</a>
			</div>
			...
			<!-- ================================================== -->
<div class="main">
	<h1 align = "center">Vendor Details</h1><br><br>
	<%
 		ResultSet rs=(ResultSet)request.getAttribute("result");
		while(rs.next()){
	%>
	<form action="CustomerUpdateServlet?role=Vendor" method="post" onsubmit="return validateFormOnSubmit(this);">
