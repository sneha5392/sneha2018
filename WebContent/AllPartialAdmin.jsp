...
<div class="container">
		...
		<div>
			...
			%>
			<h1 align="center">Partial Admin Details</h1>
			<table align=center cellspacing="2px" border="2">
				...
				<tr>
					...
					<td><a href="EditCustomerServlet?user_id=<%=rs.getString("user_id") %>&role=Partial">Edit</a> / <a href="CustomerDeleteServlet?user_id=<%=rs.getString("user_id")%>&role=Partial">Delete</a>
					</td>
				</tr>
				<%
					}
